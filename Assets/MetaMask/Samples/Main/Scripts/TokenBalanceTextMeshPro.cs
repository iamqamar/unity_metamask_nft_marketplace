...
namespace MetaMask.Unity.Samples
{
    ...
    public class TokenBalanceTextMeshPro : BindableMonoBehavior
    {
        ...
        void Start()
        {
            ...
            {
                _metaMask.Wallet.Events.WalletConnected += (_, __) => SetupWallet();
            }
        }
        ...
        private void SetupWallet()
        {
            ...
            _metaMask.Wallet.Events.ChainIdChanged += (_, __) => SetupContracts();
        }
